...
echo $count = $final['total'];
echo $format =$final['format'];

if($count == 1){
    
    
    header("Location: https://s3.ap-south-1.amazonaws.com/apnamusic/{$id}.{$format}");
...
if($update){
    ...
    header("Location: https://s3.ap-south-1.amazonaws.com/apnamusic/{$id}.{$finalFilter}");
